...
<center>![](Cool-Drink.jpg){width=600px}</center>
...
<p><div style="margin-top:50px"></div>
<center>![](giraffe_lineup4.jpg){width=800px}</center>
<div style="margin-bottom:50px"></div></p>
...
<p><div style="margin-top:50px"></div>
<center>![](giraffe_islands2.jpg){width=800px}</center>
<div style="margin-bottom:50px"></div></p>
...
Time to apply your [Intro to R knowledge](Intro_to_R.html). The heights from your logbook have been stored in a data frame called `d`. Below we show the last few observations from this vector, using the `tail()` function, which all happen to be from Island #2.
