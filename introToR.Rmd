...
---
# Ready to begin? 
You’re about to start an adventure to learn R and statistics. If this is your first time working with R, then you should begin on this page. If you’re comfortable with R basics and you’d like to start with the statistical content, please proceed onto the islands with this [link](BellCurve.html).
...
# You're ready to go! 
This was a brief introduction into R, but now you know what you need to get started with the [first module](https://dcossyleon.github.io/teacups-giraffes-and-statistics/BellCurve.html)! 
