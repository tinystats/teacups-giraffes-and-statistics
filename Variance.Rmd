...
<div style="margin-bottom:50px"></div>
  ...
  * [WHERE TO PLACE THIS POINT?] Recall the normal distribution: When we inspect the distrubtions below visually, we can see that some distributions are more spread out than others. Bell curves that are more "squished together" are composed of individuals (observations?) that are more similar to one another, while bell curves that are more "spread out" are composed of individuals that 
