...
<div class="alert alert-info">
  **Module learning objectives:**
  <ol> 
  <li> Describe the steps for constructing the sum of squares </>
...
```{r fig.show="animate", animation.hook = 'gifski', fig.width=7.2, fig.height=10, echo=FALSE, message=FALSE, warning=FALSE, results = 'hide', interval=0.01666667, fig.align = 'center'}
library(ggplot2)
s <- data.frame(x=c(113, 146.5, 132, 70.5, 121, 55), y=c(8.75,1.25,3.75,3.75,6.25,1.25))
s <- s[order(s$x),]
s <- s[c(1,2,3,6,5,4),]
...
<center><iframe style="margin: 0px;" src="static_bar.html" width="670" height="400" scrolling="yes" seamless="seamless" frameBorder="0"> </iframe></center>
   ...
   * In the plot above we see what percent of the "true" population variance an uncorrected sample variance achieves. The variances from smaller samples do the worst job of approaching 100% of the full variance. 
  ...
  * Try hovering over the bars values above for the different sample sizes, and see yourself that correction adjusts the sample variance to the full variance. You can you the window below to change the N and the hover values and then run the code. 
  
  **[MAKE THIS NOT A DATA CAMP WINDOW?]**
