...
<center>![points](images/05_correlation/points.png){width=650px}</center>
...
<center>![](images/05_correlation/points1.png){width=60%}</center>
...
<center>![](images/05_correlation/Celery.png){width=50%}</center>
...
htmltools::save_html(p,"images/05_correlation/cov_vs_sxsy.html")
