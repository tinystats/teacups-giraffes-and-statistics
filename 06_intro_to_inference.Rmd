...
output:
  bookdown::html_document2:
    includes:
      in_header: assets/inference1_image.html
...
```{r ex="histogram5", type="pre-exercise-code", cache = TRUE}
library(ggplot2)
...
<center>
```{r, tut=FALSE, echo=FALSE, message= FALSE, warning=FALSE, out.height=2, cache = TRUE}
library(plotly)
