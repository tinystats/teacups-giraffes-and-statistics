...
Recall our discussion about a sample verus a population [](BellCurve.html). Different symbols are used to represent the mean for each of these. We've already discussed ${bar_x}$ for the sample mean. The analogous symbol for the population mean is ${\mu}$ (read "mu"). Additionally, when referring to the size of the population, we will use a capital ${N}$ instead of a lowercase one. 
